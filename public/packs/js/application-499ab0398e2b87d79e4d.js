...
__webpack_require__(/*! ./procedures */ "./app/javascript/packs/procedures.js"); //= require jquery3
//= require jquery_ujs
//= require popper
//= require bootstrap
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  $("#procedure_region").change(function () {
    ...
    $('#procedure_comuna').children().remove(); //agregar al select de comunas los datos del json
  ...
  $('#add_delito_btn').click(function () {
    $('#delitos').append($('#new_delito').html());
  });
});
...
/******/ });
//# sourceMappingURL=application-499ab0398e2b87d79e4d.js.map