...
u1 = User.create(police_unit: pu, email: "frefref", password: "1234", password_confirmation: '123123')
u2 = User.create(local_prosecution: prosecution)
procedure = Procedure.create(classification: 0, marks: ["Categoria 1", "Categoria 2"], police_unit_in_charge_id: pu.id, police_in_charge: u1, local_prosecution_in_charge: prosecution, prosecutor_in_charge: u2)
