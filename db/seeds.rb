...
CrimeInAccused.create(person: imputado, crime_id: 101, procedure: procedure, preponderant: true)
CrimeInAccused.create(person: imputado, crime_id: 310, procedure: procedure, preponderant: false)
