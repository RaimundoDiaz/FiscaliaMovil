...
procedure2 = Procedure.create(story: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", state: 0, address: "Alicura 4339", sector: "Lo Barnechea", region: "Metropolitana", classification: 1, police_unit_in_charge_id: 10101, police_in_charge: police, local_prosecution_in_charge_id: 103, prosecutor_in_charge: prosecutor, involves_deceased: true)
...
tag6 = Tag.create(name: "Disturbio")
...
Tagging.create(tag: tag4, procedure: procedure2)
Tagging.create(tag: tag5, procedure: procedure2)
Tagging.create(tag: tag6, procedure: procedure2)
